package com.springbatch.test.policy;

import com.springbatch.test.exception.DatabaseException;
...
public class ProductSkipPolicy implements SkipPolicy {
    ...
    private static final Logger logger = LoggerFactory.getLogger(ProductSkipPolicy.class);
    private final int skipLimit;

    public ProductSkipPolicy(int skipLimit) {
